...
import { ArrowLeft, BookOpen, Calendar, Clock, ArrowRight, Tag, TrendingUp, Sparkles, Video, Shield, Zap } from "lucide-react";
...
const posts = [
  {
    id: 1,
    title: "Como Baixar Vídeos do Kwai Sem Marca d'Água em 2026",
    excerpt: "Aprenda o passo a passo completo para baixar vídeos do Kwai em alta qualidade, sem marca d'água e de forma totalmente gratuita. Descubra dicas exclusivas para obter a melhor qualidade possível.",
    date: "08 Abr 2026",
    readTime: "5 min",
    tag: "Tutorial",
    icon: Video,
  ...
  {
    id: 2,
    title: "Kwai vs TikTok: Qual Plataforma é Melhor para Criadores?",
    excerpt: "Comparação detalhada entre Kwai e TikTok analisando recursos, monetização, alcance e ferramentas disponíveis para criadores de conteúdo no Brasil.",
    date: "05 Abr 2026",
    readTime: "8 min",
    tag: "Análise",
    icon: TrendingUp,
  ...
  {
    id: 3,
    title: "10 Dicas para Criar Vídeos Virais no Kwai",
    excerpt: "Descubra as estratégias utilizadas pelos maiores criadores do Kwai para alcançar milhões de visualizações. Desde a escolha do tema até a edição final.",
    date: "01 Abr 2026",
    readTime: "6 min",
    tag: "Dicas",
    icon: Sparkles,
  ...
  {
    id: 4,
    title: "Segurança Digital: Como Proteger Seus Dados ao Baixar Vídeos",
    excerpt: "Guia completo sobre segurança digital ao utilizar serviços de download online. Saiba como identificar sites seguros e proteger sua privacidade.",
    date: "28 Mar 2026",
    readTime: "4 min",
    tag: "Segurança",
    icon: Shield,
  ...
  {
    id: 5,
    title: "Novidades do Kwai: Recursos Lançados em 2026",
    excerpt: "Confira todas as atualizações e novos recursos que o Kwai lançou neste ano, incluindo novas ferramentas de edição, filtros e opções de monetização.",
    date: "25 Mar 2026",
    readTime: "7 min",
    tag: "Novidades",
    icon: Zap,
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-card border border-border rounded-2xl overflow-hidden mb-10 hover:shadow-lg transition-all duration-300">
          {posts[0].image && (
            <img src={posts[0].image} alt={posts[0].title} className="w-full h-48 sm:h-64 object-cover" />
          )}
          <div className="p-6">
            <div className="flex items-center gap-2 mb-3">
              <span className={`text-xs font-semibold px-2.5 py-1 rounded-full ${tagColors[posts[0].tag]}`}>
                {posts[0].tag}
              </span>
            ...
            <article key={post.id} className="bg-card border border-border rounded-2xl overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              ...
              <div className="p-5">
                <div className="flex items-center gap-2 mb-2">
                  <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${tagColors[post.tag]}`}>
                    {post.tag}
                  </span>
        ...
        <div className="mt-12 text-center">
          <Link to="/" className="inline-flex items-center gap-2 gradient-kwai text-primary-foreground font-semibold px-6 py-2.5 rounded-xl shadow-kwai hover:shadow-kwai-lg transition-all">
            Voltar ao Início
          </Link>
        </div>
      </main>
