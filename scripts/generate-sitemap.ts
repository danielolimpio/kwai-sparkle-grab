...
const entries: SitemapEntry[] = [
  ...
  { path: "/baixar-videos-kwai-sem-marca-dagua", changefreq: "weekly", priority: "0.92" },
  { path: "/baixar-videos-kwai-no-pc", changefreq: "weekly", priority: "0.9" },
  { path: "/baixar-videos-kwai-no-iphone", changefreq: "weekly", priority: "0.9" },
